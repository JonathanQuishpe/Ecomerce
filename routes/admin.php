...
Route::group(['prefix' => 'admin'], function () {
    ...
    /* Route::get('/', 'Admin\LoginController@home')->name('admin.dashboard')->middleware('auth:admin'); */
    Route::group(['middleware' => ['auth:admin']], function () {
        Route::get('/', 'Admin\LoginController@home')->name('admin.dashboard');
        /*Route::get('/', function () {
    ...
    Route::group(['prefix' => 'users'], function () {
        Route::get('/', 'Admin\LoginController@users')->name('admin.users.index');
    });
});
