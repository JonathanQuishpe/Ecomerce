            ...
            <div class="login-box">
                <form class="login-form" action="{{ route('admin.login.post') }}" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="email" id="email" name="email" placeholder="Dirección de correo" autofocus value="{{ old('email') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group btn-container">
                        <button class="btn btn-primary btn-block" type="submit"><i class="fa fa-sign-in fa-lg fa-fw"></i>INICIAR SESION</button>
                    </div>
                </form>
            </div>
        </section>
