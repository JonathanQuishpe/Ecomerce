...
class AttributeController extends BaseController {
    ...
    public function index() {
        ...
        $this->setPageTitle('Atributos', 'Lista de todos los atributos');
        return view('admin.attributes.index', compact('attributes'));
    }

    public function create() {
        $this->setPageTitle('Atributos', 'Crear Atributo');
    ...
    public function store(Request $request) {
        $this->validate($request, [
            ...
            'frontend_type.required' => 'El tipo de campo es requerido.'
        ]);
    ...
    public function edit($id) {
        ...
        $this->setPageTitle('Atributos', 'Editar Atributo : ' . $attribute->name);
    ...
    public function update(Request $request) {
        ...
        return $this->responseRedirectBack('Atributo actualizado con éxito', 'success', false, false);
    }
    ...
    public function delete($id) {
        ...
        return $this->responseRedirect('admin.attributes.index', 'Atributo borrado con éxito', 'success', false, false);
    }
