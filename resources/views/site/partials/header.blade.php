            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="brand-wrap">
                        <a href="{{ url('/') }}">
                            <img class="logo-icon" src="{{url('/')}}/{{ config('settings.site_logo')}}" alt="logo" height="100vh">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="widgets-wrap d-flex justify-content-end">
                        <div class="widget-header">
                            <a href="{{ route('checkout.cart') }}" class="icontext">
                                ...
                                <div class="text-wrap">
                                    <small>{{ $cartCount }} productos</small>
                                </div>
                            </a>
                        </div>
                        @guest
                        ...
                        <div class="widget-header">
                            <a href="{{ route('register') }}" class="ml-3 icontext">
                                ...
                                <div class="text-wrap"><span>Registrarse</span></div>
                            </a>
                        </div>
                        @else
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('account.orders') }}">Ordenes</a>
